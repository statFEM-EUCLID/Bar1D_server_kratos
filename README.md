...
This file presents the black box FEM solver for UQ quantification problems serving the [StatFEMEUCLID.jl](https://github.com/statFEM-EUCLID/StatFEMEUCLID.jl) client. The selected interface is [UM-Bridge](https://um-bridge-benchmarks.readthedocs.io/en/docs/) for connecting the FEM solver ([Kratos](https://github.com/KratosMultiphysics/Kratos)) and the UQ server.
